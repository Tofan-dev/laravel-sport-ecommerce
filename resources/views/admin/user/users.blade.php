        ...
        <nav id="sidebarMenu" class="collapse d-lg-block sidebar collapse bg-white">
            <div class="position-sticky">
                <div class="list-group list-group-flush mx-3 mt-4">
                    ...
                    <a href="{{ url('/users') }}" class="list-group-item list-group-item-action py-2 ripple active"><i
                                ...
                                <th scope="col">
                                    ...
                                    @if (isset($user->information))
                                        <details>
                                            ...
                                            <p> Country: {{ $user->information->country }}</p> <br>
                                            <p> City: {{ $user->information->city }}</p> <br>
                                            <p> Adress: {{ $user->information->adress }}</p> <br>
                                            <p> Postal code:{{ $user->information->postal_code }}</p> <br>
                                            <p> Phone number: {{ $user->information->phone_number }}</p> <br>
                                        </details>
                                    @else
                                        <p> No more informations.</p>
                                    @endif
