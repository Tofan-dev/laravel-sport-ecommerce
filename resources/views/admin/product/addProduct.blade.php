    ...
    <main style="margin-top: 58px;">
        ...
        <div class="container pt-4">
            ...
            <form action="{{ route('storeCategory') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label for="product_category_title">Category </label>
                    <br>
                   
                    <select name="product_category_title" id="product_category_title">
                ...
                <div class="form-group">
                    <label for="product_sale">Sale available</label>
                    <br>
                   
                    <select name="product_sale" id="product_sale">
                ...
                <div class="form-group">
                    <label for="product_priceWithDiscount">Price with discount</label>
                    <input type="number" name="product_priceWithDiscount" class="form-control">
                    @error('product_priceWithDiscount')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
                <div class="form-group">
